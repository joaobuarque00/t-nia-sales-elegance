...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="group fixed bottom-20 right-4 z-50 inline-flex items-center gap-3 rounded-full bg-[#25D366] px-4 py-3 text-white shadow-luxe transition-transform duration-500 hover:scale-105 sm:bottom-6 sm:right-6"
    >
