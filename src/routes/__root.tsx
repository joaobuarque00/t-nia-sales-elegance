...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Buffet de luxo para casamentos, 15 anos, aniversários, formaturas e eventos corporativos. Gastronomia refinada, decoração sofisticada e atendimento impecável." },
      { name: "author", content: "Tânia Sales Buffet" },
      { property: "og:title", content: "Tânia Sales Buffet — Eventos de Luxo" },
      { property: "og:description", content: "Buffet premium com gastronomia refinada e decoração sofisticada para o seu evento dos sonhos." },
